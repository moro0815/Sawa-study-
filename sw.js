...
const CACHE = "sawa-navi-v30";
const ASSETS = [
  "./", "./index.html", "./share.html", "./manifest.json",
  "./css/style.css",
  "./js/evidence.js", "./js/curriculum.js", "./js/homework.js", "./js/learning.js", "./js/memory.js", "./js/luke.js", "./js/speech.js", "./js/camera.js", "./js/safe.js", "./js/rawlog.js", "./js/write.js", "./js/today.js", "./js/cause.js", "./js/transfer.js", "./js/karte.js", "./js/english.js", "./js/careers.js",
